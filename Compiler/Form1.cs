...
using System.IO;
using static Compiler.SyntaxError;
...
namespace Compiler
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            SyntaxErrListener listener = new SyntaxErrListener();
            SyntaxErrListenerLexer listenerForLexer = new SyntaxErrListenerLexer();
            ...
            for (int i = 0; i < listener.SyntaxErrors.Count; i++)
            {
                ResultField.Text += listener.SyntaxErrors[i].ToString()+'\n';
            }

            for (int i = 0; i < listenerForLexer.SyntaxErrors.Count; i++)
            {
                ResultField.Text += listenerForLexer.SyntaxErrors[i].ToString() + '\n';
            }
        }
